 ...
 *
 * This file is a test driver for the Polymorphic classes prescribed in Project 6 
of CS-202
 */
#include <iostream>
#include "Car.h"
...
int main(){
  ...
  cout << "\n" <<
          ...
          "/////   Polymorphism Tests  /////\n" <<
          "/////////////////////////////////" << endl;
  cout << endl << "Testing VIRTUAL Move Function for DERIVED Class Objects" << 
endl;
  float lla_new[3] = {37.77, 122.42, 52.0};
  c1.Move( lla_new );  
  cout << endl << "Testing Insertion operator<< Overload for BASE Class Objects" <<
endl;
  cout << c_rno << endl;
  ...
  cout << endl << "Testing Insertion operator<< Overload for Base Class Pointers" 
<< endl;
  for (int i=0; i<3; ++i){
